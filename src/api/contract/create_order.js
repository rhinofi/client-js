...
module.exports = (
  ...
  if (amount > 0) {
    ...
    sellAmount = new BigNumber(10)
      ...
      .toNumber();
    */
    buyAmount = amount * price * Math.pow(10, 10)
    sellAmount = amount * price * Math.pow(10, 10)
  ...
  var starkOrder = {
    ...
    expiration_timestamp: 438953 // new BigNumber(expiration)
  }
  ...
  try {
    starkMessage = sw.get_limit_order_msg(
      ...
      starkOrder.amount_sell.toString(), // amount_sell (uint63 decimal str)
      starkOrder.amount_buy.toString(), // amount_buy (uint63 decimal str)
