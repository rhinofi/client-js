...
describe('registers', () => {
  ...
  it('Registers user with Stark Ex', async done => {
    ...
    const result = await dvf.register(starkKey, deFiSignature)
  ...
  it('Register method checks for starkKey', async done => {
    ...
    const response = await dvf.register(null, deFiSignature)
  ...
  it('Register method checks for deFiSignature', async done => {
    ...
    const response = await dvf.register(starkKey, null)
