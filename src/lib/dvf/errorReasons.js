module.exports = {
  ...
  ERR_STARK_REGISTRATION_MISMATCH: 'The registered Stark key does not match the provided Stark key',
  ...
  ERR_CORE_ETHFX_0X_FEE_RECIPIENT_INVALID: 'The fee recipient address was not specified as Deversifi.',
  ERR_CORE_ETHFX_0X_TAKER_INVALID: 'The taker address for the trade was not specified as Deversifi.',
  ...
  ERR_STARK_KEY_MISSING: 'Stark key not provided',
  ERR_STARK_KEY_PAIR_MISSING: 'Stark key pair not provided',
