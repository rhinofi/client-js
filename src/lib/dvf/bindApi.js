...
module.exports = () => {
  ...
  dvf.getVaultIdAndDeversifiVaultId = compose(require('../../api/getVaultIdAndDeversifiVaultId'))
  dvf.getVaultIdFromServer = compose(require('../../api/getVaultIdFromServer'))
  dvf.getVaultIdAndDeversifiVaultIdFromServer = compose(require('../../api/getVaultIdAndDeversifiVaultIdFromServer'))
